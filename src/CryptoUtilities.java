...
public final class CryptoUtilities {
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        NaturalNumber two = new NaturalNumber2("2");
        NaturalNumber ogN = new NaturalNumber2(n);
        NaturalNumber ogP = new NaturalNumber2(p);
        ...
        if (p.isZero()) {
            ...
            //If odd, multiply by original n value one more time
            if (!isEven(p)) {
                n.multiply(ogN);
            }
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        //Assume prime if cannot disprove through functions below
        boolean isWitness = false;

        NaturalNumber copyNMinusOne = new NaturalNumber2(n);
        NaturalNumber copyW = new NaturalNumber2(w);
        NaturalNumber copyW2 = new NaturalNumber2(w);

        copyNMinusOne.decrement();

        powerMod(copyW, TWO, n);
        powerMod(copyW2, copyNMinusOne, n);

        if (copyW.compareTo(ONE) == 0 || copyW2.compareTo(ONE) != 0) {
            isWitness = true;
        }
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
            ...
            copyN.decrement();
            NaturalNumber copyNMinusOne = new NaturalNumber2(copyN);

            while (!isPrime && count < TWENTY) {
                ...
                if (n.compareTo(TWO) > 0 && witness.compareTo(ONE) > 0
                        && witness.compareTo(copyNMinusOne) < 0) {
